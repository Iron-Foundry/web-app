export const queryKeys = {
  ...
  ranking: {
    ...
    profile: (rsn: string) => ["ranking", "profile", rsn] as const,
  },
  services: {
  ...
  tilerace: {
    ...
    recap: (eventId: string) => ["tilerace", "recap", eventId] as const,
    ...
    submissions: (eventId: string, status?: string) =>
      ["tilerace", "submissions", eventId, status ?? "all"] as const,
